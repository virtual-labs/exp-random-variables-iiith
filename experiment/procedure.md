...
### Sub-Experiment 1 _($\sigma$ algebra)_ :

In this sub-experiment, there are a few examples, one of which is selected randomly:

- For each example, select the required sets from the pink tiles to form the smallest $\sigma$ algebra.
...
### Sub-Experiment 2 _(Inverse image)_ :
